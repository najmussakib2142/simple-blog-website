            ...
            <div className="max-w-6xl mx-auto px-7 md:px-6 lg:px-8 pt-12 pb-4 md:pb-8">
                ...
                <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-12 md:gap-y-12">
                    ...
                    <div className="col-span-2 lg:col-span-4 pr-8">
                        <Link href="/" className="text-2xl font-extrabold tracking-tight text-blue-900 mb-4 inline-block">
                            SimpleBlog
                        </Link>
                    ...
                    <div className="col-span-1 md:col-span-1 lg:col-span-2">
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><Link href="/blogs" className="text-gray-600 hover:text-blue-900 transition-colors">All Blogs</Link></li>
                            <li><Link href="/blogs/create" className="text-gray-600 hover:text-blue-900 transition-colors">Create</Link></li>
                            <li><Link href="/about" className="text-gray-600 hover:text-blue-900 transition-colors">About</Link></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-span-1 md:col-span-1 lg:col-span-2">
                        ...
                        <ul className="space-y-3 text-sm">
                            <li><a href="#" className="text-gray-600 hover:text-blue-900 transition-colors">Contact Us</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-blue-900 transition-colors">Privacy Policy</a></li>
                            <li><a href="#" className="text-gray-600 hover:text-blue-900 transition-colors">Terms of Service</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="col-span-2 md:col-span-4 lg:col-span-4 mt-2 md:mt-0">
                        ...
                        <div className="flex items-center gap-4">
                            {/* Twitter/X */}
                            <a href="#" className="text-gray-600 hover:text-blue-900 transition-colors" aria-label="Twitter">
                            ...
                            {/* YouTube */}
                            <a href="#" className="text-gray-600 hover:text-blue-900 transition-colors" aria-label="YouTube">
                            ...
                            {/* LinkedIn */}
                            <a href="#" className="text-gray-600 hover:text-blue-900 transition-colors" aria-label="LinkedIn">
                ...
                <div className="md:pt-8 md:mt-8 pt-6 mt-6 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center">
                    ...
                    <div className="text-sm text-gray-500 space-x-4 order-1 sm:order-2">
                        ...
                        {/* <a href="#" className="hover:text-blue-900 transition-colors">Cookie Settings</a> */}
                    </div>
                </div>
            </div>
        </footer>
