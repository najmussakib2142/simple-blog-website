        ...
        <div className="bg-white">
            ...
            <section className="py-16 sm:py-20 px-7 md:px-14 bg-gray-50">
                <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 md:gap-20 items-start">
                    {/* Why SimpleBlog */}
                    <div>
                        <p className="text-indigo-600 font-semibold uppercase text-sm tracking-wider mb-4">
                            Why SimpleBlog?
                        </p>
            ...
            {/* CTA Section */}
            <section className="py-16 sm:py-20 px-6 md:px-8 max-w-6xl mx-auto text-center">
                <div className="space-y-8">
                    ...
                    <div className="flex flex-wrap gap-4 justify-center">
                        <Link
                            href="/blogs"
                            className="inline-flex items-center px-6 sm:px-8 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition-colors shadow-md"
                        >
                            Explore Blogs
                        </Link>
                        <Link
